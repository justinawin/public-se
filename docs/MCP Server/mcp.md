...
Owlbert's 2025 Journeys hosts a remote MCP server at `https://owlberts-2025-journeys-cc.readme.io/mcp`. Configure your AI development tools to connect to this server using your Owlbert's 2025 Journeys API key.
    ...
    ```json
    {
      "mcpServers": {
        "owlberts-2025-journeys-cc": {
          "url": "https://owlberts-2025-journeys-cc.readme.io/mcp?authorization=Bearer [YOUR_API_KEY]"
        }
      }
    }
    ```

    Replace `[YOUR_API_KEY]` with your actual Owlbert's 2025 Journeys API key.
  </Tab>
  <Tab title="Windsurf">
